...
GITLAB_RAIL_INITIAL_ROOT_PASSWORD = 'NVwi2UQQY3GCovZLHwR3taqpBiEP0pnYU4dgkdFPtEQ=' # 您的 root 密码，后面可以自己注册自己的账号和密码，给管理员即可。注意：密码根据示例修改即可，不知什么原因，自定义一些其它简单的密码登陆不了
